...
def Average_col(filename,sheet_name,column):
...
col_tpi= Average_col("12626455.xlsx","Daily Log",5)
col_phai= Average_col("12626455.xlsx","Daily Log",3)
col_sri= Average_col("12626455.xlsx","Daily Log",2)
col_abi= Average_col("12626455.xlsx","Daily Log",10)
col_tui= Average_col("12626455.xlsx","Daily Log",9)
col_dci= Average_col("12626455.xlsx","Daily Log",2)
...
col_aai= AAI("12626455.xlsx","Daily Log",4,6)
...
col_ei= EI("12626455.xlsx","Daily Log",11,12,13)
